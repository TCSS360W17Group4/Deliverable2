...
public class JobController implements Serializable{
    ...
    public boolean isStartDateAdded(String theDate) {
        ...
        if(jobStartDate != null) {
            ...
            if (hasJobStartDateAllowVolunteerSignUp(currentDate, jobStartDate) && 
                ...
                //Don't have max jobs on start date
     ...
     * Checks against MAX_ALLOWED_DATE_INTO_FUTURE
     * 
     * @param currentDate
     * @param jobStartDate
     ...
     * Checks against MAX_JOB_LENGTH_IN_DAYS
     * 
     * Also checks for obvious condition of duration not being zero or negative days
     * 
